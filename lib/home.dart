          ...
          child: Row(
            children: [
              const CircleAvatar(
                radius: 16,
                backgroundColor: Colors.white,
                child: Icon(Icons.person, size: 18, color: Colors.blueAccent),
              ),
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    'M. Khaqan Nasir', // Replace with actual name dynamically
                    style: TextStyle(
                      fontSize: 18,
                      color: Colors.white,
                      fontWeight: FontWeight.bold,
        ...
        children: _features.map((f) {
          return GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [Colors.blueAccent.withOpacity(0.1), Colors.blueAccent.withOpacity(0.05)],
                  begin: Alignment.topLeft,
                  end: Alignment.bottomRight,
                ),
                borderRadius: BorderRadius.circular(12),
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: Icon(f["icon"] as IconData, size: 30, color: Colors.blueAccent),
                  ),
                  const SizedBox(height: 10),
                  Text(
                    f["title"],
